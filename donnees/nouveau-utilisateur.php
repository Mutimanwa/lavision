...
<div class=" col-xl-12 h-100">
    <div class="d-flex mb-4"><span class="fa-stack me-2 ms-n1">
        ...
        <div class="col">
            <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Ajout du
                    professeur</span><span
                    class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
            <p class="mb-0">Ajouter facilement un professeur dans le systeme en utilisant ces formulaire.</p>
        </div>
    </div>
    <div class="card theme-wizard h-100 mb-5">
        <div class="card-header bg-body-tertiary pt-3 pb-2">
            <ul class="nav justify-content-between nav-wizard" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link fw-semi-bold active" href="#bootstrap-wizard-validation-tab1"
                        data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                        <span class="nav-item-circle-parent"><span class="nav-item-circle">
                                <span class="fas fa-lock"></span> </span></span><span
                            class="d-none d-md-block mt-1 fs-10">Account</span></a>
                </li>
                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                        href="#bootstrap-wizard-validation-tab2" data-bs-toggle="tab" data-wizard-step="2"
                        aria-selected="false" role="tab" tabindex="-1"><span class="nav-item-circle-parent"><span
                                class="nav-item-circle"><span class="fas fa-user"></span> </span></span><span
                            class="d-none d-md-block mt-1 fs-10">Personal</span></a>
                </li>
                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                        href="#bootstrap-wizard-validation-tab3" data-bs-toggle="tab" data-wizard-step="3"
                        aria-selected="false" role="tab" tabindex="-1"><span class="nav-item-circle-parent"><span
                                class="nav-item-circle">
                                <span class="fas fa-dollar-sign"></span> </span></span><span
                            class="d-none d-md-block mt-1 fs-10">Billing</span></a></li>
                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold"
                        href="#bootstrap-wizard-validation-tab4" data-bs-toggle="tab" data-wizard-step="4"
                        aria-selected="false" tabindex="-1" role="tab"><span class="nav-item-circle-parent"><span
        ...
        <div class="card-body py-4" id="wizard-controller">
            ...
            <div class="tab-pane px-sm-3 px-md-5 active show" role="tabpanel"
                    ...
                    <form class="needs-validation was-validated" novalidate="novalidate" data-wizard-form="1">
                        <div class="mb-3"><label class="form-label"
                                for="bootstrap-wizard-validation-wizard-name">Name</label><input class="form-control"
                        ...
                        <div class="form-check"><input class="form-check-input" type="checkbox" name="terms"
                                ...
                                id="bootstrap-wizard-validation-wizard-checkbox"><label class="form-check-label"
                                for="bootstrap-wizard-validation-wizard-checkbox">I accept the <a href="#!">terms
                ...
                <div class="tab-pane px-sm-3 px-md-5 " role="tabpanel"
                    ...
                    <form data-wizard-form="2">
                                ...
                                <div class="col-md">
                                    <div class="dz-message dropzone-area px-2 py-3" data-dz-message="data-dz-message">
                                        <div class="text-center"><img class="me-2"
                                            ...
                                            your profile picture<p class="mb-0 fs-10 text-400">Upload a 300x300 jpg
                        ...
                        <div class="mb-3"><label class="form-label"
                                for="bootstrap-wizard-validation-gender">Gender</label><select class="form-select"
                        ...
                        <div class="mb-3"><label class="form-label"
                                for="bootstrap-wizard-validation-wizard-phone">Phone</label><input class="form-control"
                                type="text" name="phone" placeholder="Phone"
                                id="bootstrap-wizard-validation-wizard-phone"></div>
                        <div class="mb-3"><label class="form-label"
                                for="bootstrap-wizard-validation-wizard-datepicker">Date of Birth</label><input
                                class="form-control datetimepicker flatpickr-input" type="text" placeholder="dd/mm/yy"
                                data-options="{&quot;dateFormat&quot;:&quot;dd/mm/yy&quot;,&quot;disableMobile&quot;:true}"
                                id="bootstrap-wizard-validation-wizard-datepicker" readonly="readonly"></div>
                        <div class="mb-3"><label class="form-label"
                ...
                <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab3"
                    id="bootstrap-wizard-validation-tab3">
                    <form class="form-validation" data-wizard-form="2">
                        <div class="row g-2">
                            <div class="col-md">
                                <div class="mb-3"><label class="form-label"
                                        for="bootstrap-wizard-validation-card-number">Card Number</label><input
                                        class="form-control" placeholder="XXXX XXXX XXXX XXXX" type="text"
                                        id="bootstrap-wizard-validation-card-number"></div>
                            </div>
                            <div class="col-md">
                                <div class="mb-3"><label class="form-label"
                                        for="bootstrap-wizard-validation-card-name">Name on Card</label><input
                                        class="form-control" placeholder="John Doe" name="cardName" type="text"
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3"><label class="form-label"
                                        for="bootstrap-wizard-validation-card-holder-zip-code">Zip Code</label><input
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-0"><label class="form-label"
                                        for="bootstrap-wizard-validation-card-exp-date">Exp Date</label><input
                                        class="form-control" placeholder="15/2024" name="expDate" type="text"
                                        id="bootstrap-wizard-validation-card-exp-date"></div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-0"><label class="form-label"
                                        for="bootstrap-wizard-validation-card-cvv">CVV</label><span class="ms-1"
                                        ...
                                        </svg><!-- <span class="fa fa-question-circle"></span>  --></span><input
                                        class="form-control" placeholder="123" name="cvv" maxlength="3"
                                        pattern="[0-9]{3}" type="text" id="bootstrap-wizard-validation-card-cvv"></div>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="wizard-lottie-wrapper">
                        <div class="lottie wizard-lottie mx-auto my-3"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                viewBox="0 0 264 464" width="264" height="464" preserveAspectRatio="xMidYMid meet"
                                ...
                                <g clip-path="url(#__lottie_element_22)">
                                    <g transform="matrix(1,0,0,1,132,232)" opacity="1" style="display: block;">
                                        <g opacity="1" transform="matrix(1,0,0,1,0,182)">
                                            <g opacity="1"
                                            ...
                                            <g opacity="1"
                                                ...
                                                <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.8571673035621643,-0.5150380730628967,0.5150380730628967,0.8571673035621643,-39.404170989990234,19.655147552490234)">
                                                            <path fill="rgb(209,226,253)" fill-opacity="1"
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.8480480909347534,0.5299192667007446,-0.5299192667007446,0.8480480909347534,50.08690643310547,-13.999801635742188)">
                                                            <path fill="rgb(209,226,253)" fill-opacity="1"
                                            ...
                                            <g opacity="1"
                                                ...
                                                <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.7313537001609802,-0.6819983720779419,0.6819983720779419,0.7313537001609802,-76.83961486816406,-44.260719299316406)">
                                                            <path fill="rgb(209,226,253)" fill-opacity="1"
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.7313537001609802,0.6819983720779419,-0.6819983720779419,0.7313537001609802,36.262020111083984,62.31349182128906)">
                                                            <path fill="rgb(209,226,253)" fill-opacity="1"
                                                ...
                                                <g opacity="1" transform="matrix(1,0,0,0.75,0,15.995750427246094)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        <path fill="rgb(66,133,244)" fill-opacity="1"
                                            ...
                                            <g opacity="1"
                                                ...
                                                <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.5150380730628967,-0.8571673035621643,0.8571673035621643,0.5150380730628967,-34.378150939941406,95.98683166503906)">
                                                            <path fill="rgb(203,240,248)" fill-opacity="1"
                                                        ...
                                                        <g opacity="1"
                                                            transform="matrix(0.7547096014022827,0.6560590267181396,-0.6560590267181396,0.7547096014022827,72.00469970703125,-48.33330535888672)">
                                                            <path fill="rgb(203,240,248)" fill-opacity="1"
                                        ...
                                        <g opacity="1"
                                            transform="matrix(0.9816271662712097,0.1908089965581894,-0.1908089965581894,0.9816271662712097,2.9829235076904297,261.24072265625)">
                                            <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        <path fill="rgb(209,226,253)" fill-opacity="1"
                                                ...
                                                <g opacity="1"
                                                    transform="matrix(0.5909379124641418,-0.806717038154602,0.806717038154602,0.5909379124641418,-5.305299758911133,-12.532085418701172)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        <path fill="rgb(209,226,253)" fill-opacity="1"
                                                ...
                                                <g opacity="1"
                                                    transform="matrix(0.7908195853233337,0.6120492815971375,-0.6120492815971375,0.7908195853233337,18.834266662597656,-9.155939102172852)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        <path fill="rgb(209,226,253)" fill-opacity="1"
                                            ...
                                            <g opacity="1"
                                                transform="matrix(0.0523359552025795,0.9986295104026794,-0.9986295104026794,0.0523359552025795,62.36345291137695,-54.05506134033203)">
                                                <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                    <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                        <path fill="rgb(203,240,248)" fill-opacity="1"
            ...
            <div class="px-sm-3 px-md-5">
                <ul class="pager wizard list-inline mb-0">
                    <li class="previous"><button class="btn btn-link ps-0 d-none" type="button"><svg
                            ...
                            </svg><!-- <span class="fas fa-chevron-left me-2" data-fa-transform="shrink-3"></span>  -->Prev</button>
                    </li>
                    <li class="next"><button class="btn btn-primary px-5 px-sm-6" type="submit">Next<svg
                                class="svg-inline--fa fa-chevron-right fa-w-10 ms-2" data-fa-transform="shrink-3"
                            ...
                            </svg><!-- <span class="fas fa-chevron-right ms-2" data-fa-transform="shrink-3"> </span>  --></button>
                    </li>
                </ul>
            </div>
        </div>
