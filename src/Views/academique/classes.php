    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 px-4 py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?php echo BASE_URL; ?>/academique/classes/ajouter" class="btn btn-primary">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form method="get" action="<?php echo BASE_URL; ?>/academique/classes" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select class="form-select" id="niveau" name="niveau">
                                ...
                                <?php foreach ($data['niveaux'] as $niveau): ?>
                                    <option value="<?php echo $niveau['id']; ?>"
                                            <?php echo ($data['filtres']['niveau'] == $niveau['id']) ? 'selected' : ''; ?>>
                            ...
                            <select class="form-select" id="section" name="section">
                                ...
                                <?php foreach ($data['sections'] as $section): ?>
                                    <option value="<?php echo $section['id']; ?>"
                                            <?php echo ($data['filtres']['section'] == $section['id']) ? 'selected' : ''; ?>>
                            ...
                            <select class="form-select" id="annee_scolaire" name="annee_scolaire">
                                ...
                                <?php foreach ($data['annees_scolaires'] as $annee): ?>
                                    <option value="<?php echo $annee['id']; ?>"
                                            <?php echo ($data['filtres']['annee_scolaire'] == $annee['id']) ? 'selected' : ''; ?>>
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                                ...
                                <tbody>
                                    <?php foreach ($data['classes'] as $classe): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $classe['annee_debut']; ?> - <?php echo $classe['annee_fin']; ?>
                                            </td>
                                            <td>
                                                <?php if ($classe['nom_prof_principal']): ?>
                                                    <?php echo htmlspecialchars($classe['nom_prof_principal'] . ' ' . $classe['prenoms_prof_principal']); ?>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="<?php echo BASE_URL; ?>/academique/classes/voir/<?php echo $classe['id']; ?>"
                                                       class="btn btn-outline-info" title="Voir les détails">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo BASE_URL; ?>/academique/classes/modifier/<?php echo $classe['id']; ?>"
                                                       class="btn btn-outline-warning" title="Modifier">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirmerSuppression(<?php echo $classe['id']; ?>, '<?php echo htmlspecialchars($classe['nom_classe']); ?>')"
                                                            title="Supprimer">
                        ...
                        <?php if ($data['pagination']['total_pages'] > 1): ?>
                            <nav aria-label="Pagination des classes" class="mt-4">
                                <ul class="pagination justify-content-center">
                                    <?php if ($data['pagination']['page_actuelle'] > 1): ?>
                                        <li class="page-item">
                                            <a class="page-link" href="<?php echo buildPaginationUrl($data['pagination']['page_actuelle'] - 1, $data['filtres']); ?>">
                                    ...
                                    <?php for ($i = max(1, $data['pagination']['page_actuelle'] - 2); $i <= min($data['pagination']['total_pages'], $data['pagination']['page_actuelle'] + 2); $i++): ?>
                                        <li class="page-item <?php echo ($i == $data['pagination']['page_actuelle']) ? 'active' : ''; ?>">
                                            <a class="page-link" href="<?php echo buildPaginationUrl($i, $data['filtres']); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
...
function exportClasses() {
    const params = new URLSearchParams(window.location.search);
    const url = '<?php echo BASE_URL; ?>/academique/classes/exporter?' + params.toString();
