...
<div class="row py-4">
    ...
    <div class="row">
                                ...
                                <select class="form-select <?php echo isset($data['erreurs']['niveau_id']) ? 'is-invalid' : ''; ?>"
                                    ...
                                    <?php foreach ($data['niveaux'] as $niveau): ?>
                                        <option value="<?php echo $niveau['niveau_id']; ?>"
                                                <?php echo (isset($data['valeurs']['niveau_id']) && $data['valeurs']['niveau_id'] == $niveau['id']) ? 'selected' : ''; ?>>
                                            <?php echo htmlspecialchars($niveau['nom_niveau']); ?> 
                                            <!-- (<?php echo htmlspecialchars($niveau['code_niveau']); ?>) -->
                                        </option>
                                    <?php endforeach; ?>
                                </select>
        ...
        <div class="col-lg-4">
            ...
            <!-- Aperçu des types -->
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-200 text-dark">
                    <h6 class="card-title mb-0">
            ...
            <!-- Statistiques -->
            <div class="card shadow-sm">
                <div class="card-header bg-200 text-white">
                    <h6 class="card-title mb-0">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ['type_matiere', 'niveau_id'].forEach(function(fieldId) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        const requiredFields = ['nom_matiere', 'code_matiere', 'type_matiere', 'niveau_id'];
