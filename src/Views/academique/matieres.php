    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 px-4 py-4">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form method="get" action="<?php echo BASE_URL; ?>/academique/matieres" class="row g-3">
                        <div class="col-md-4">
                                ...
                                <tbody>
                                    <?php foreach ($data['matieres'] as $matiere): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="<?php echo BASE_URL; ?>/academique/matieres/voir/<?php echo $matiere['id']; ?>"
                                                       class="btn btn-outline-info" title="Voir les détails">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo BASE_URL; ?>/academique/matieres/modifier/<?php echo $matiere['id']; ?>"
                                                       class="btn btn-outline-warning" title="Modifier">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirmerSuppression(<?php echo $matiere['id']; ?>, '<?php echo htmlspecialchars($matiere['nom_matiere']); ?>')"
                                                            title="Supprimer">
            ...
            <div class="row mt-4">
                <div class="col-md-3 mb-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body text-center">
                            <div class="h3 mb-0"><?php echo $data['pagination']['total_matieres']; ?></div>
                            <small>Matières totales</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="card bg-success text-white">
                        <div class="card-body text-center">
                            <div class="h3 mb-0">
                                <?php echo count(array_filter($data['matieres'], fn($m) => $m['type_matiere'] === 'fondamentale')); ?>
                            </div>
                            <small>Fondamentales</small>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body text-center">
                            <div class="h3 mb-0">
                                <?php echo count(array_filter($data['matieres'], fn($m) => $m['type_matiere'] === 'optionnelle')); ?>
                            </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-info text-white">
                        <div class="card-body text-center">
                            <div class="h3 mb-0">
                                <?php echo count(array_filter($data['matieres'], fn($m) => $m['type_matiere'] === 'specialisee')); ?>
                            </div>
                            <small>Spécialisées</small>
                        </div>
                    </div>
                </div>
            </div>
