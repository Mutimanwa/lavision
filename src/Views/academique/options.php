        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL; ?>/academique/niveau/ajouter" class="btn btn-light btn-sm">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL; ?>/academique/section/ajouter" class="btn btn-light btn-sm">
                        <i class="fas fa-plus me-1"></i>
                        Ajouter
                    </a>
                </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL; ?>/academique/annee-scolaire/ajouter" class="btn btn-light btn-sm">
                        <i class="fas fa-plus me-1"></i>
                        Ajouter une Année Scolaire
                    </a>
                </div>
                <div class="card-body">
                    <?php if (empty($data['annees_scolaires'])): ?>
                        <div class="text-center py-4">
                            <i class="fas fa-calendar-times fa-3x text-muted mb-3"></i>
                            <h5 class="text-muted">Aucune année scolaire configurée</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="<?= url('academique/annee-scolaire/modifier',['id' => $annee['annee_id']]);?>" class="btn btn-outline-primary">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                        <a href="<?= url('academique/annee-scolaire/activer' ,  ['id' => $annee['annee_id']]);?>" class="btn btn-outline-success">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="text-center">
                                    <div class="h4 text-primary mb-0"><?php echo $data['annee_scolaire']['annee_libelle']; ?></div>
