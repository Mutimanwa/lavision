                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text"
                                       ...
                                       placeholder="Identifiant, email, nom...">
                            </div>
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                ...
                                <a href="<?php echo BASE_URL; ?>/administration/utilisateurs" class="btn btn-outline-secondary">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-bold"><?php echo htmlspecialchars($utilisateur['prenom'] . ' ' . $utilisateur['nom']); ?></div>
                                                        <small class="text-muted"><?php echo htmlspecialchars($utilisateur['identifiant']); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="dropdown-item" href="#" onclick="resetPassword(<?php echo $utilisateur['user_id']; ?>)">
                                                                    <i class="fas fa-key me-2"></i>Réinitialiser MDP
                                                                </a>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="#" onclick="deleteUser(<?php echo $utilisateur['user_id']; ?>)">
                            ...
                            <nav aria-label="Navigation des utilisateurs" class="mt-4">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item <?php echo $pagination['page'] <= 1 ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="<?php echo $pagination['page'] > 1 ? '?page=' . ($pagination['page'] - 1) . '&search=' . urlencode($search) . '&role=' . urlencode($role) . '&statut=' . urlencode($statut) : '#'; ?>">
                                    ...
                                    <?php for ($i = max(1, $pagination['page'] - 2); $i <= min($pagination['pages'], $pagination['page'] + 2); $i++): ?>
                                        <li class="page-item <?php echo $i === $pagination['page'] ? 'active' : ''; ?>">
                                            <a class="page-link" href="?page=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&role=<?php echo urlencode($role); ?>&statut=<?php echo urlencode($statut); ?>">
                                                <?php echo $i; ?>
                                            </a>
                                        </li>
                                    <?php endfor; ?>
                                    ...
                                    <li class="page-item <?php echo $pagination['page'] >= $pagination['pages'] ? 'disabled' : ''; ?>">
                                        <a class="page-link" href="<?php echo $pagination['page'] < $pagination['pages'] ? '?page=' . ($pagination['page'] + 1) . '&search=' . urlencode($search) . '&role=' . urlencode($role) . '&statut=' . urlencode($statut) : '#'; ?>">
...
<div class="modal fade" id="addUserModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo BASE_URL; ?>/administration/utilisateurs/ajouter">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="role" name="role" required>
                                ...
                                <?php foreach ($roles as $role_key => $role_label): ?>
                                    <option value="<?php echo $role_key; ?>"><?php echo htmlspecialchars($role_label); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
