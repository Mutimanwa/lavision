        ...
        <div class="container">
            <div class="row flex-center min-vh-100 py-6 text-center">
                <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5"><a class="d-flex flex-center mb-4"
                        href="<?= BASE_URL?>"><img class="me-2" src="<?= IMAGES_URL?>icons/spot-illustrations/falcon.png" alt=""
                            width="58" /><span
                    ...
                    <div class="card">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <p class="lead mt-4 text-800 font-sans-serif fw-semi-bold w-md-75 w-xl-100 mx-auto">La page
                                que vous cherchez n'est pas trouvée.</p>
                            <hr />
                            <p>Assurez-vous que l'adresse est correcte et que la page n'a pas été déplacée. Si vous
                                pensez que c'est une erreur, <a href="mailto:info@exmaple.com">contact nous</a>.</p><a
                                class="btn btn-primary btn-sm mt-3" href="<?= BASE_URL?>"><span
                                    class="fas fa-home me-2"></span>Retour à l'accueil</a>
                        </div>
                    </div>
                </div>
            </div>
